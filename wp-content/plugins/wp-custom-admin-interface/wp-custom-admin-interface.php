...
function wp_custom_admin_interface_custom_frontend_css() {
    ...
    if(isset($options['wp_custom_admin_interface_deactivate_frontend_code'])){} else {
        ...
        if(is_string($options['wp_custom_admin_interface_custom_frontend_css_code']) && strlen($options['wp_custom_admin_interface_custom_frontend_css_code'])>0){  
        ...
        if(is_string($options['wp_custom_admin_interface_custom_frontend_javascript_code']) && strlen($options['wp_custom_admin_interface_custom_frontend_javascript_code'])>0){
